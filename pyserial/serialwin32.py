...
import pyserial
from pyserial.serialutil import SerialBase, SerialException, to_bytes, PortNotOpenError, SerialTimeoutException
...
class Serial(SerialBase):
    ...
    def _reconfigure_port(self):
        ...
        if self._bytesize == pyserial.FIVEBITS:
            comDCB.ByteSize = 5
        elif self._bytesize == pyserial.SIXBITS:
            comDCB.ByteSize = 6
        elif self._bytesize == pyserial.SEVENBITS:
            comDCB.ByteSize = 7
        elif self._bytesize == pyserial.EIGHTBITS:
            comDCB.ByteSize = 8
        else:
        ...
        comDCB.XonChar = pyserial.XON
        comDCB.XoffChar = pyserial.XOFF
    ...
    def exclusive(self, exclusive):
        ...
        if exclusive is not None and not exclusive:
            ...
            pyserial.SerialBase.exclusive.__set__(self, exclusive)
